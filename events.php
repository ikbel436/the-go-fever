...
<!-- Mirrored from preview.colorlib.com/theme/voyage/Events.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 29 Nov 2020 08:43:14 GMT -->
<head>
...
<!--                                          ===============           HOUNI YA EKBAL  ============                                  -->
        <?PHP
          ...
          <div class="col-lg-3 promo ftco-animate">
           <a href="#" class="promo-img mb-4"  style="background-image: url(images/<?PHP echo $row['imageevent']; ?>);"  ></a>

            <div class="text text-center">
              <h2><?PHP echo $row['nomevent']; ?></h2>
              <h3 class="price"><?PHP echo $row['nbrplace']; ?> Places </h3>
              <h2><?PHP echo $row['descriptionevent']; ?></h2>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 Events d-block text-center">
